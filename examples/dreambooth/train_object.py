...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--style_instance_prompt",
        type=str,
        default=None,
        required=True,
        help="The prompt with identifier specifying the instance(style)",
    )
    parser.add_argument(
        "--object_instance_prompt",
        type=str,
        default=None,
        required=True,
        help="The prompt with identifier specifying the instance(object)",
    )
    parser.add_argument(
        "--class_prompt",
        type=str,
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.style_instance_prompt = style_instance_prompt
        self.object_instance_prompt = object_instance_prompt
    ...
    def __getitem__(self, index):
        ...
        if self.encoder_hidden_states is not None:
            ...
            if pattern.match(image_path.name):
                tmp_prompt = f"Image of a: {self.object_instance_prompt}"
            else:
                tmp_prompt = f"Image of style: {self.style_instance_prompt}"
            text_inputs = tokenize_prompt(
                self.tokenizer, tmp_prompt, tokenizer_max_length=self.tokenizer_max_length
            )
...
def main(args):
    print("Style prompt:", args.style_instance_prompt)
    print("Object prompt:", args.object_instance_prompt)
    jt.flags.use_cuda = 1
   ...
   #unet.requires_grad_(False)
    ...
    train_dataset = DreamBoothDataset(
        ...
        style_instance_prompt=args.style_instance_prompt,
        object_instance_prompt=args.object_instance_prompt,
